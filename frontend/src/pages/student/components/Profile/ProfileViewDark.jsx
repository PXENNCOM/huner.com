...
const ProfileViewDark = ({ profile }) => {
  if (!profile) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-blue-200 mb-2">Profile information not found</h3>
        <p className="text-blue-300 text-sm">Please edit your profile information.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <div className="mb-3">
              {profile.department && profile.school ? (
                ...
                <p className="text-blue-300 text-sm">No education information added</p>
              )}
      ...
      {/* Skills */}
      <div className="bg-blue-800/30 backdrop-blur-xl rounded-xl p-6 border border-blue-700/30">
        <h3 className="text-lg font-medium text-white mb-4">Skils</h3>
        {profile.skills ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-blue-300">No skills added yet</p>
            <p className="text-blue-400 text-sm mt-1">You can add your skills from the profile editing section</p>
          </div>
        )}
      </div>
