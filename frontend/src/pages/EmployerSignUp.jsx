          ...
          <div className="space-y-6 animate-fadeIn">
            <div className="space-y-4">
              <div className="group">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Building className="h-5 w-5 text-blue-300 group-focus-within:text-blue-400 transition-colors" />
                  </div>
                  <input
                    type="text"
                    id="companyName"
              ...
              <div className="group">
                <label htmlFor="position" className="block text-sm font-medium text-blue-200 mb-2">
                  Position <span className="text-red-300">*</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Briefcase className="h-5 w-5 text-blue-300 group-focus-within:text-blue-400 transition-colors" />
                  </div>
                  <input
                    type="text"
                    id="position"
                    ...
                    className="block w-full pl-10 pr-4 py-3 !bg-white/5 border border-white/20 rounded-xl text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-[#0158C1] focus:border-transparent focus:!bg-white/5 transition-all duration-200 backdrop-blur-sm"
                    placeholder="Your Position (e.g., HR Manager, CEO)"
                  />
                </div>
              </div>
              ...
              <div className="group">
                <label htmlFor="companyWebsite" className="block text-sm font-medium text-blue-200 mb-2">
              ...
              <div className="group">
                ...
                <p className="mt-1 text-xs text-blue-300">Include country code</p>
              </div>
            </div>
          </div>
        );
      ...
      <div className="relative w-full max-w-md z-10">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8 transform transition-all duration-500">
          ...
          <div className="text-center mb-8">
            <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#0158C1] to-[#004493] rounded-2xl mb-4 shadow-lg transition-all duration-500 ${
              ...
              {currentStep === 2 && <Building className="w-8 h-8 text-white transition-all duration-300" />}
              {currentStep === 3 && <Lock className="w-8 h-8 text-white transition-all duration-300" />}
            </div>
            <h2 className="text-2xl font-bold text-white text-center">Employer Registration</h2>
            <p className="text-blue-200 text-center mt-2">Create a new employer account</p>
          </div>
        ...
        <div className="mt-8 text-center space-y-3">
          <p className="text-sm text-blue-200">
            Are you a student?{' '}
            <Link to="/student/signup" className="font-medium text-blue-300 hover:text-blue-200 transition-colors duration-200">
